...
func NewCounterRepo(instance *mongo.Database) entity.CounterRepository {
...
func getLatestCounter(ctx context.Context, db *mongo.Database) (res *entity.Counter, err error) {
	collection := db.Collection("counter")
...
func incrementCounter(ctx context.Context, db *mongo.Database, identifier string, latestCounter entity.Counter) error {
	collection := db.Collection("counter")
...
func (r *counterRepo) Get(ctx context.Context, collectionName string, identifier string) (id uint32, err error) {
